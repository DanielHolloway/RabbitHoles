...
public class ArticleValidator {
	...
	public static void validateCreateArticle(final Article article) {
		...
		if (isBlank(article.getLink())) throw new ArticleValidationException("First name should not be null");
		if (isBlank(article.getTopic())) throw new ArticleValidationException("Last name should not be null");
	}
